...
export default {
  ...
  theme: {
    ...
    extend: {
      fontFamily: { display: ["Orbitron", "sans-serif"], body: ["Rajdhani", "sans-serif"], sans: ["Rajdhani", "sans-serif"] },
      colors: {
        ...
        neon: { blue: "hsl(var(--neon-blue))", purple: "hsl(var(--neon-purple))", cyan: "hsl(var(--neon-cyan))" },
        rank: { e: "hsl(var(--rank-e))", d: "hsl(var(--rank-d))", c: "hsl(var(--rank-c))", b: "hsl(var(--rank-b))", a: "hsl(var(--rank-a))", s: "hsl(var(--rank-s))" },
      },
